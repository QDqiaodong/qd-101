...
public class RedisCacheConfig {
    ...
    public RedisCacheManagerBuilderCustomizer redisCacheManagerBuilderCustomizer() {
        ...
        cacheConfigurations.put("hot_activities",
                defaultCacheConfiguration().entryTtl(Duration.ofMinutes(5)));

        cacheConfigurations.put("activities",
                defaultCacheConfiguration().entryTtl(Duration.ofMinutes(10)));

        cacheConfigurations.put("activity_detail",
                defaultCacheConfiguration().entryTtl(Duration.ofMinutes(15)));

        cacheConfigurations.put("user_activities",
                defaultCacheConfiguration().entryTtl(Duration.ofMinutes(10)));

        cacheConfigurations.put("user_registrations",
                defaultCacheConfiguration().entryTtl(Duration.ofMinutes(5)));
